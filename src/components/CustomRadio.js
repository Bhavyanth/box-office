...
// Every time we render a component, it'll create a copy of that function => react will compare
// those two copies by using memo (Objects are compared by reference and not by value)
